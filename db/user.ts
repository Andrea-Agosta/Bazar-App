...
export const createNewUser = async (userId: string, userFirstName: string, userLastName: string, userEmail: string, userRegistrationDate: Date, userAvatar: expressFileUpload.FileArray): Promise<IUser> => {
...
export const updateUser = async (userId: string, userFirstName: string, userLastName: string, userEmail: string, userRegistrationDate: Date, userAvatar: expressFileUpload.FileArray): Promise<IUser> => {
